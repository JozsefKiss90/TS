...
**Why it matters for Hermes:** mock-first is a settled curriculum decision, and this double is the ancestor of Phase 1's `FakeModelGateway` — the [[model-gateway]] implementation that lets the whole agent loop be tested offline, deterministically, without a model.

**Related:** [[messages-api]] · [[model-gateway]] · [[base-url]] · [[request-contract]] · [[error-boundary]]

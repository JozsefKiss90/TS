...
**Amended 2026-08-08 (row 14).** Consider cutting or splitting before adding required content. An amendment must state what it removes or replaces, and a repair may not raise a lesson's word budget without the user raising it. Rows 1–13 all closed by addition, because this rule permitted nothing else.
...
| 14 | **Reading cost was never a constraint, so it grew without limit.** Measured across the eight shipped lessons: mean sentence length rose 15.6 → 27.0 words, body length 1,339 → 7,217 words, em-dashes 26 → 185, sentences over 35 words 5 → 44. The cause is this record's own procedure. Article VII answers a confusion report by amending an Article, and all nine Article III standards *add* required content; none limited length, sentence complexity, or vocabulary. So rows 1–13 could only ever produce more apparatus. Article III.7 required *deconfusing* a coinage but never prohibited inventing one, which licensed *policy seed*, *honest ledger*, *deconfusion*, *spine thread*, *wire truth*, *the six*, *the three graphs*. Lesson 0006a spends ~380 words on why it exists before its first teaching sentence, and its five-sentence "compression" is 178 words. Two supplements for one lesson (0006a + 0006b = 12,500 words) is a split that never happened | user report, 2026-08-08, with measurements in `docs/style/ste-profile.md` §1 | **VIII Readability** (new, binding — `docs/style/ste-profile.md`); III.7 amended from *deconfuse coinages* to *do not coin*; III.8 compression bounded to 5 sentences × 25 words; III.9 labels confined to one table; II.4 given a 2,000-word number; **VII amended so a repair may subtract** |

 ...
 *
 * Carried forward from exercise 05, unchanged. Exercise 06 adds a
 * contract for the WORK (task-spec.ts); this is the contract for the
 * CALL. They are different boundaries and they stay separate files.
 *
